    ...
    const renderComponent = (item, index) => {
        switch (item.type) {
            ...
            case "ImageText":
                ...
                <ImageText
                    key={index}
                    imageInfo={item.data.imageInfo}
                    textContent={item.data.textContent}
                    inverted={item.data.inverted}
                />
                );
            case "Tiles":
            ...
            case "EmailForm":
                return <EmailForm key={index} emailTitle={item.data.emailTitle} emailDescription={item.data.emailDescription} emailUrgency={item.data.emailUrgency} emailUrgencyText={item.data.emailUrgencyText} />
            default:
                return null;
        }
    };
