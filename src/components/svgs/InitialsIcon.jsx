...
const InitialsIcon = ({ classes = "", width = "48px", height = "48px", fill = "currentColor" }) => {
    return (
        <svg 
            fill={fill}  
            version="1.1" 
        ...
        >
            <g id="5151e0c8492e5103c096af88a51e7e7e">
                <path d="M218.195,257.521c0,64.719,4.624,119.1-27.309,151.283c-17.961,18.105-46.301,28.772-81.17,28.772
